...
write.table(species, "../figures/Merged_Table.tsv", quote = F, row.names = F, sep = "\t")
...
write.table(COIs, "../figures/Distances.txt", quote = F, sep = "\t", row.names = F)
